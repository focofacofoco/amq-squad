...
### Task/schema and CLI pruning (P6, PR #652)
...
All feature work merged in PRs #647–#652.
...
- **Final measured delta at the feature-complete main (`6164626e`, PR #652
  merged): 361 files changed, 13,246 insertions, 52,437 deletions — net
  −39,191 lines versus v2.27.0.** The subsequent release-packaging commit adds
  documentation and manifest bumps only (no production code). The approved
  plan's estimate was at least −30,000 lines; the measured result exceeds it.
