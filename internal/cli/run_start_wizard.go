...
func parseRunStartWizardPrefill(args []string) (runwizard.Spec, error) {
	...
	binary := registerRepeatedRoleMapFlag(fs, "binary", "")
	model := registerRepeatedRoleMapFlag(fs, "model", "")
	effort := registerRepeatedRoleMapFlag(fs, "effort", "")
	toolProfile := registerRepeatedRoleMapFlag(fs, "tool-profile", "")
